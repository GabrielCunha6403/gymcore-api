...
estabelecimento pode possuir várias unidades.
  ...
  ----------------------- ----------------------- -----------------------
  `id_estabelecimento`    `bigint`                  Identificador único do
                                                  estabelecimento.
...
seus dados próprios de identificação, contato e endereço.
  ...
  Coluna                  Tipo                    Descrição
  ----------------------- ----------------------- -----------------------
  `id_unidade`            `bigint`                  Identificador único da
                                                  unidade.

  `id_estabelecimento`    `bigint`                  Estabelecimento ao qual
                                                  a unidade pertence.
...
Define os horários de funcionamento de uma unidade por dia da semana.
  ...
  Coluna                               Tipo                    Descrição
  ------------------------------------ ----------------------- -----------------------
  `id_unidade_horario_funcionamento`   `bigint`                  Identificador único do
                                                               horário de
                                                               funcionamento.

  `id_unidade`                         `bigint`                  Unidade à qual o
                                                               horário pertence.
...
Representa o papel de aluno assumido por uma pessoa.
  ...
  Coluna         Tipo          Descrição
  -------------- ------------- -----------------------------------------
  `id_aluno`     `bigint`        Identificador único do aluno.
...
Representa o papel profissional de professor assumido por uma pessoa.
  ...
  Coluna                    Tipo                    Descrição
  ------------------------- ----------------------- -----------------------
  `id_professor`            `bigint`                  Identificador único do
                                                    professor.
...
modalidade.
  ...
  Coluna                  Tipo                    Descrição
  ----------------------- ----------------------- -----------------------
  `id_modalidade`         `bigint`                  Identificador único da
                                                  modalidade.

  `id_estabelecimento`    `bigint`                  Estabelecimento
                                                  proprietário da
                                                  modalidade.
...
específica.
  ...
  Coluna                    Tipo                    Descrição
  ------------------------- ----------------------- -----------------------
  `id_unidade_modalidade`   `bigint`                  Identificador único da
                                                    relação entre unidade e
                                                    modalidade.

  `id_unidade`              `bigint`                  Unidade que oferece a
                                                    modalidade.

  `id_modalidade`           `bigint`                  Modalidade
                                                    disponibilizada.
...
Representa o vínculo de um professor com uma unidade específica.
  ...
  Coluna                   Tipo                    Descrição
  ------------------------ ----------------------- -----------------------
  `id_professor_unidade`   `bigint`                  Identificador único do
                                                   vínculo.

  `id_professor`           `bigint`                  Professor vinculado.

  `id_unidade`             `bigint`                  Unidade na qual o
                                                   professor atua.
...
determinada unidade.
  ...
  Coluna                              Tipo                    Descrição
  ----------------------------------- ----------------------- -----------------------
  `id_professor_unidade_modalidade`   `bigint`                  Identificador único do
                                                              vínculo.

  `id_professor_unidade`              `bigint`                  Vínculo do professor
                                                              com a unidade.

  `id_unidade_modalidade`             `bigint`                  Modalidade oferecida
                                                              pela unidade e
...
condições específicas são configuradas posteriormente por unidade.
  ...
  Coluna                  Tipo                    Descrição
  ----------------------- ----------------------- -----------------------
  `id_plano`              `bigint`                  Identificador único do
                                                  plano.
...
comerciais específicas.
  ...
  Coluna                    Tipo                    Descrição
  ------------------------- ----------------------- -----------------------
  `id_plano_unidade`        `bigint`                  Identificador único da
                                                    oferta do plano na
                                                    unidade.

  `id_plano`                `bigint`                  Plano disponibilizado.

  `id_unidade`              `bigint`                  Unidade que oferece o
                                                    plano.
...
uma unidade.
  ...
  Coluna                        Tipo                    Descrição
  ----------------------------- ----------------------- -----------------------
  `id_plano_unidade_desconto`   `bigint`                  Identificador único da
                                                        regra de desconto.

  `id_plano_unidade`            `bigint`                  Oferta de plano à qual
                                                        o desconto pertence.
...
unidade estão incluídas em determinado plano da unidade.
  ...
  Coluna                    Tipo                    Descrição
  ------------------------- ----------------------- -----------------------
  `id_plano_unidade`        `bigint`                  Plano oferecido pela
                                                    unidade.

  `id_unidade_modalidade`   `bigint`                  Modalidade da unidade
                                                    incluída no plano.
...
unidade.
  ...
  Coluna                  Tipo                    Descrição
  ----------------------- ----------------------- -----------------------
  `id_matricula`          `bigint`                  Identificador único da
                                                  matrícula.

  `id_aluno`              `bigint`                  Aluno associado à
                                                  matrícula.

  `id_plano_unidade`      `bigint`                  Plano e unidade
...
Representa um desconto efetivamente associado a uma matrícula.
  ...
  Coluna                        Tipo                    Descrição
  ----------------------------- ----------------------- -----------------------
  `id_matricula_desconto`       `bigint`                  Identificador único do
                                                        desconto da matrícula.

  `id_matricula`                `bigint`                  Matrícula beneficiada
                                                        pelo desconto.

  `id_plano_unidade_desconto`   `bigint`                  Regra de desconto do
...
valores financeiros utilizados naquela competência.
  ...
  Coluna                  Tipo                    Descrição
  ----------------------- ----------------------- -----------------------
  `id_mensalidade`        `bigint`                  Identificador único da
                                                  mensalidade.

  `id_matricula`          `bigint`                  Matrícula que originou
                                                  a cobrança.
...
Registra os pagamentos realizados para uma mensalidade.
  ...
  Coluna                  Tipo                    Descrição
  ----------------------- ----------------------- -----------------------
  `id_pagamento`          `bigint`                  Identificador único do
                                                  pagamento.

  `id_mensalidade`        `bigint`                  Mensalidade associada
                                                  ao pagamento.
...
entrada e saída.
  ...
  Coluna                  Tipo                    Descrição
  ----------------------- ----------------------- -----------------------
  `id_frequencia`         `bigint`                  Identificador único do
                                                  registro de frequência.

  `id_aluno`              `bigint`                  Aluno que realizou o
                                                  acesso.

  `id_unidade`            `bigint`                  Unidade em que a
                                                  presença foi
                                                  registrada.
...
determinada unidade.
  ...
  Coluna                    Tipo                    Descrição
  ------------------------- ----------------------- -----------------------
  `id_turma`                `bigint`                  Identificador único da
                                                    turma.

  `id_unidade_modalidade`   `bigint`                  Modalidade da unidade à
                                                    qual a turma pertence.

  `id_professor_unidade`    `bigint`                  Professor da unidade
...
Define os horários recorrentes associados a uma turma.
  ...
  Coluna               Tipo          Descrição
  -------------------- ------------- --------------------------------------
  `id_turma_horario`   `bigint`        Identificador único do horário.
  `id_turma`           `bigint`        Turma à qual o horário pertence.
...
Representa o vínculo de uma matrícula com uma turma específica.
  ...
  Coluna                  Tipo                    Descrição
  ----------------------- ----------------------- -----------------------
  `id_aluno_turma`        `bigint`                  Identificador único do
                                                  vínculo.

  `id_matricula`          `bigint`                  Matrícula utilizada
                                                  para participar da
                                                  turma.

  `id_turma`              `bigint`                  Turma associada à
                                                  matrícula.
...
determinado papel de acesso.
  ...
  Coluna                         Tipo                    Descrição
  ------------------------------ ----------------------- -----------------------
  `id_usuario_estabelecimento`   `bigint`                Identificador único da
                                                         associação.
...
Registra alterações relevantes realizadas no contexto de uma unidade.
  ...
  Coluna                   Tipo                    Descrição
  ------------------------ ----------------------- -----------------------
  `id_unidade_auditoria`   `bigint`                  Identificador único do
                                                   evento de auditoria.

  `id_unidade`             `bigint`                  Unidade à qual a
                                                   auditoria está
                                                   associada.
  ...
  `id_registro`            `bigint`                  Identificador do
                                                   registro alterado.
